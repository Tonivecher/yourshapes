...
const imageList = [
  ...
  { src: "projects/gen1.png", caption: "Модульная гардеробная стена с латунными ручками — премиальная отделка и безупречные стыки." },
  { src: "projects/gen2.png", caption: "Встраиваемый почтовый блок с гравировкой номеров — точная геометрия и спокойная палитра." },
  { src: "projects/gen3.png", caption: "Индустриальная кухня с сетчатыми фасадами и массивом лиственницы — баланс брутальности и тепла." },
  { src: "projects/gen4.png", caption: "Приёмная зона с длинной витриной ZARYAD — аккуратная навигация и равномерное освещение." },
  { src: "projects/gen5.png", caption: "Металлические шкафчики с гравировкой и ключами — чёткая организация пространства." },
  { src: "projects/gen6.png", caption: "Островная стойка Beeline в аэропорту — витрины с подсветкой, мягкая графика бренда." },
  { src: "projects/gen7.png", caption: "Экспозиционный блок для наушников — деревянные сферы-подиумы и витринное стекло." },
  { src: "projects/gen8.png", caption: "Ресторанная группа Seating — кожаные диваны, массивные столешницы и скрытая проводка." },
];
