...
>(
  (
    ...
    return (
      <SidebarContext.Provider value={contextValue} data-oid="47109v:">
        <TooltipProvider delayDuration={0} data-oid=".4v2y0a">
          <div
            style={
              {
      ...
      return (
        ...
        >
          <SheetContent
            ...
            data-oid="2-fbix3"
          >
            <SheetHeader className="sr-only" data-oid="lixs5sl">
              <SheetTitle data-oid="wna:u..">Sidebar</SheetTitle>
              <SheetDescription data-oid="7k5x9:r">
                Displays the mobile sidebar.
              </SheetDescription>
            </SheetHeader>
            <div className="flex h-full w-full flex-col" data-oid="u6qx:52">
              {children}
            </div>
          </SheetContent>
        </Sheet>
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      data-oid="qg02:-0"
    >
      <PanelLeft data-oid="oul1mu8" />
      <span className="sr-only" data-oid=".o:o-z1">
        Toggle Sidebar
      </span>
    </Button>
  );
...
>(
  (
    ...
    return (
      <Tooltip data-oid="nm1_aua">
        <TooltipTrigger asChild data-oid="49ksho2">
          {button}
        </TooltipTrigger>
        <TooltipContent
          side="right"
...
const SidebarMenuSubItem = React.forwardRef<
  HTMLLIElement,
  React.ComponentProps<"li">
>(({ ...props }, ref) => <li ref={ref} {...props} data-oid="8qcj.3i" />);
