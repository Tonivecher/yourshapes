// webapp-pure-form-7dzsf1/apps/website/src/lib/animejs-wrapper.ts
...
// Корректный экспорт типов без переобъявления — никаких круговых алиасов.
export type {
  AnimeParams,
  AnimeInstance,
  AnimeTimelineInstance,
...
// Основной экспорт anime для удобного импорта
